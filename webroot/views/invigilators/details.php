<?php
    ...
    define('TITLE', "Add A New Invigilator | UCCIA - Put tagline here");
    define('HEADER', "Add New Invigilator");
    define('EXTRAO', 'No');
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#picture">Add A New Invigilator</a></li>
                            </ul>
                                                ...
                                                <div class="review-content-section">
                                                    <div id="dropzone1" class="pro-ad addcoursepro">
                                                        <?php 
                                                            ...
                                                            echo form_open("invigilators/invigilator_details", $attributes);    //Create form and set attributes
                                                            ...
                                                            <div class="marg">
                                                                <div duty="invigilator-deatails" class="shade col-lg-12">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                            <div class="form-group">
                                                                                <input value="<?php echo set_value('department');?>" name="department" type="text" class="form-control" placeholder="Department" max-length="50">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-12" style="margin-top: 2%;">
                                                                            <div class="payment-adress">
                                                                                <button type="submit" class="btn btn-primary waves-effect waves-light">Add Invigilator</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
