                                                ...
                                                <div class="review-content-section">
                                                    <div id="dropzone1" class="pro-ad addcoursepro">
                                                        <?php 
                                                            ...
                                                            echo form_open_multipart("invigilators/invigilator_picture", $attributes);    //Create form and set attributes
                                                                                                ...
                                                                                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                                                                                    ...
                                                                                                    <div>
                                                                                                        <span class="btn btn-theme02 btn-file">
                                                                                                            ...
                                                                                                            <input type="file" class="default" id="invigilator_picsture" name="invigilator_picsture"/>
                                                                                                        </span>
